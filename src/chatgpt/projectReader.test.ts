...
describe('Projektleser', () => {
  it('liest die sichtbare echte Projektchatliste und trennt Titel von Vorschauen', () => {
    const id = 'g-p-69f849e273fc8191ba4b3e1fb3602502'; window.history.replaceState({}, '', `/g/${id}`)
